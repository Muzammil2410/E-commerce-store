...
const Title = ({ title, description, visibleButton = true, href = '' }) => {
    ...
    return (
        <div className='flex flex-col items-center px-4'>
            ...
            <Link to={href} className='flex flex-col sm:flex-row items-center gap-1 sm:gap-3 text-xs sm:text-sm text-slate-600 dark:text-gray-300 mt-1 transition-colors duration-200'>
