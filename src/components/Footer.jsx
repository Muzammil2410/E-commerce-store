...
const Footer = () => {
    ...
    // Get first 4 products for footer display
    const featuredProducts = productDummyData.slice(0, 4);
    ...
    const linkSections = [
        {
            ...
            links: [
                ...
                { text: t('viewAllProducts'), path: '/shop', icon: null, isBold: false }
            ]
        },
        {
            title: t('website'),
            links: [
                ...
                { text: t('privacyPolicy'), path: '/privacy-policy', icon: null },
                { text: t('getSupport'), path: '/support', icon: null },
            ]
        },
        {
            title: t('contact'),
